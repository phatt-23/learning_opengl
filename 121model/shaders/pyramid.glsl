...
void main() {
    ...
    OF_FragmentColor *= ambience + diffussion;
    OF_FragmentColor += texture(U_Texture1, OV_TextureCoordinatesVec2).r * speculant;
    OF_FragmentColor *= U_LightColorVec4;
    OF_FragmentColor.w = 1.f;
}
